...
public class FindOne {
  ...
  FindOne(MongoCollection<Document> collection, ReadPreference readPreference,
      Unmarshaller unmarshaller, QueryFactory queryFactory, String query, Object... parameters) {
...
//    }
  ...
  public <T> T map(ResultHandler<T> resultHandler) {
    ...
    Bson projection = getFieldsAsBson();
    Bson sort = getOrderByAsBson();
  ...
  private Bson getFieldsAsBson() {
    return fields == null ? null : fields.toBsonDocument();
  }

  private Bson getOrderByAsBson() {
    return orderBy == null ? null : orderBy.toBsonDocument();
  }
}
