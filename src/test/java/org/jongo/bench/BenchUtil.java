...
//    }
//
//    public static MongoCollectionWrapper getCollectionFromJongo(Mapper mapper) throws UnknownHostException {
...
//        MongoCollectionWrapper collection = getCollectionFromJongo(jacksonMapper().build());
//        collection.drop();
