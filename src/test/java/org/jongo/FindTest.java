...
//        Friend friend = new Friend(new ObjectId(), "John");
//        collection.save(friend);
//        CustomMongoCursor<Friend> friends = collection.find("{name:'John'}").as(Friend.class);
//
...
//
//        /* when */
//        CustomMongoCursor<Friend> friends = collection.find().as(Friend.class);
//
//        /* then */
//        assertThat(friends.hasNext()).isTrue();
...
//
//        /* when */
//        CustomMongoCursor<Friend> friends = collection.withReadPreference(ReadPreference.primaryPreferred()).find("{name:'John'}").as(Friend.class);
//
//        /* then */
//        assertThat(friends.hasNext()).isTrue();
//        assertThat(friends.next().getName()).isEqualTo("John");
